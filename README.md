...
By default only allowlisted chat/completions models are shown (Go: 16, Zen: 17 including free models). Enable **Show all models** to expose every model from the API, including non-chat models that may fail.
