...
final class CampaignStoppingPointTest extends MonkeyTestCase {
	...
	/**
	 * The campaign queue records the completed Model Radar item and no active work.
	 */
	public function test_queue_records_completed_model_radar_item(): void {
		...
		self::assertStringContainsString( 'GROWTH-001', $queue );
