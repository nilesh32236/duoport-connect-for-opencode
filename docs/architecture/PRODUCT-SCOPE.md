...
| PF-007 Verified image-generation contract | in progress | Current image list is empty; establish provider payload, response, and media-safety evidence before exposure |
